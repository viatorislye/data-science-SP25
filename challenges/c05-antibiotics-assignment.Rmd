...
- What is your response to the question above?
  ...
  - Gram stain
    - For neomycin & streptomycin, the gram stain generally didn't seem to have a correlation with the amount of neomycin & streptomycin needed. 
    - However,for penicillin, the negative gram generally had a lower MIC while gram positive generally had much high MIC. This predicts a possible correlation between gram strain and their MIC need for the antibiotic penicillin.
  - Genera
    - For staphylococcus, neomycim generally gave the lowest MIC, then was penicillin and then streptomycin. 
    - For salmonella, neomcyin also generally gave the lowest MIC but wasn't as low as staphylococcus's MIC.
...
- Why?
  ...
  - You can see the split between gram size really well where positive gram follows a mountain peak trend and negative gram follows valley trend centered at penicillin 
...
- What is your response to the question above?
  ...
  - Diplococcus pneumoniae was renamed because it was very similar reaction to the antibiotics as the Streptococcus genera does.
...
- Why?
  ...
  - You can see that Streptococcus hemolyticus & Streptococcus viridans have very similar graphs to Diplococcus pneumoniae and if you combine different components from the two I listed, you can create the Diplococcus pneumoniae graph. 

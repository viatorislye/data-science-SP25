...
- The higher the gdp per cap a country has, the longer the life expectancy is for those who live in that country
```{r q5-task2}
...
- The mean gdp per cap has increase but the range of gdp as also increase as time goes on.

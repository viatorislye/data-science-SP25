...
- Document your observations here.
  - Nantucket has a large error bar going from ~10,000 to 275000
    dollars.
  - Norfolk seems to have the higher median household income across all
    households on average for all counties
  - Four & five person household tend to have the highest median
    household income across all counties
- Can you confidently distinguish between household incomes in Suffolk
  county? Why or why not?
  - Sort of as the color help distinguish them from each other however
    they are so similar it is hard to read
- Which counties have the widest confidence intervals?
  - Nantucket has the largest 3 & 5 person confidence interval
  - Hampsire has the largest 6 person confidence interval
  - Dukes has the largest 2& 4 person confidence interval
...
- What *overall* trend do you see between `SE` and population? Why might
  this trend exist?
  - There seems to be a of a the higher the population estimate is the
    smaller the income standard error is. This may exist because large
    population (cities) are located where there is a higher minimum
    wages and and to afford living in the cities, you must have certain
    income to afford it. It can also be that there are more income to
    compare to in cities versus rural communities where outliners can
...
df_data %>% 
  ...
  ggplot(aes(population_estimate, income_estimate)) +
  geom_point() +

  coord_flip() +
  labs(
    x = "Population Estimate by County",
    y = "Median Household Income",
  ) +
...
![](c09-income-assignment_files/figure-gfm/bonus-1.png)<!-- -->

**Observations**:

- I made two graphs
- The first graphs did not show a big correlation between population and
  median income
- There is an outlier in county population in Vermont which is
  Chittenden county, where Burlington is located. This however did not
  mean they earned the more income by county in Vermont. Only for 2,3,4
  person house were that at the top or tied with another county.
- I made the second graph as I found it weird that Essex county had an
  error bar that went from -30,000 to over 150,000 for 6 person
  households. I think there might just not be many 6 person household in
  the county.

...
- What is the mean of E by thickness?
  - For thickness .022, the mean was 10600.00. For thickness .032, the mean was 10383.33. For thickness .064, the mean was 10500.00. For thickness .081, the mean was 9975.00.
## Visualize
<!-- ------------------------- -->
...
- Is this evidence *conclusive* one way or another?
  - There is a general trend as the thickness decrease, the nu increases and E increases in value. This shows a correlation between the physical property and the material property. It also makes sense that if there is more material, it's less bendy as there are more atoms packed toward. You can bend a thin skewer more than a pencil before it breaks.
